---
name: puzzle-activity-book-creator
description: Creates complete puzzle and activity books, including page plans, original puzzle content, image-generated activity pages, answer keys, and covers.
---
...
Create complete puzzle and activity books with organized difficulty, original content, answer keys, and coordinated visual design.
...
- Riddles
- Matching games
- Spot-the-difference concepts
- Scavenger and observation activities
- Mixed puzzle books

## Workflow

1. Define audience, theme, difficulty, trim size, page count, and number of activities.
2. Build a difficulty progression.
3. Create original puzzle content and maintain an answer database.
4. Generate visual puzzle pages, decorative elements, section dividers, and cover artwork with ChatGPT Image Generation 2.0.
5. Verify that every puzzle is solvable.
6. Generate matching answer-key pages.
7. Check that fonts, line weights, and puzzle elements reproduce clearly in print.
8. Create the KDP listing and series ideas.
