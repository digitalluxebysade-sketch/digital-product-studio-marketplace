---
name: kdp-product-bundle-creator
description: Creates coordinated KDP product families and companion products with matching visual systems, interiors, covers, and listings.
---
...
Create a coordinated family of KDP books or companion products around one audience, transformation, brand, or theme.

## Examples

- Gratitude journal + self-care planner + reflection workbook
- Student planner + study log + assignment tracker
- Budget planner + savings challenge + expense log
- Children’s tracing book + coloring book + activity book

## Workflow

1. Define the bundle audience and shared promise.
2. Select products that complement one another instead of repeating the same function.
3. Create a master visual identity for the full family.
4. Build an individual page plan for each product.
5. Generate all unique interiors, title pages, dividers, covers, and listing images with ChatGPT Image Generation 2.0.
6. Create coordinated titles, subtitles, descriptions, and cross-sell language.
7. Create a release strategy and bundle map.
8. Run quality control on each product separately and on the collection as a whole.
