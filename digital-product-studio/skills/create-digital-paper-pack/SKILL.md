---
name: create-digital-paper-pack
description: Create a coordinated collection of original seamless digital papers with pattern tests, high-resolution exports, previews, and licensing notes. Use when the user asks for seamless patterns, scrapbook paper, digital paper, printable backgrounds, or a coordinated pattern pack.
---
...
Create a coordinated collection of original seamless digital papers with pattern tests, high-resolution exports, previews, and licensing notes.

## Trigger

Use when the user asks for seamless patterns, scrapbook paper, digital paper, printable backgrounds, or a coordinated pattern pack.

## Required outputs

- Theme, palette, pattern list, and scale plan
- Original seamless pattern tiles
- High-resolution square digital papers in requested sizes
- Light, medium, and bold pattern balance
- Contact sheet, listing previews, and file guide

## Workflow

1. Define theme, palette, paper count, pixel size, DPI, file format, and commercial use.
2. Plan a varied collection using hero patterns, supporting patterns, textures, and simple coordinates.
3. Generate pattern artwork with ChatGPT Image Generation 2.0 and create true seamless repeats.
4. Test every pattern on a large repeated canvas for visible seams or mismatched edges.
5. Export consistent high-resolution papers and clearly label scale or color variants.
6. Create previews that show both full sheets and close-up pattern detail.

## Quality checks

- Every advertised seamless paper repeats cleanly on all four edges.
- No paper includes unintended text, signatures, watermarks, or copyrighted marks.
- The collection is coordinated without becoming visually repetitive.
- Files use consistent dimensions, resolution, color mode, and names.
