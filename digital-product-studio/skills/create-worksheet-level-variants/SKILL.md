---
name: create-worksheet-level-variants
description: Turn one worksheet concept into beginner, standard, and advanced versions with differentiated instructions, scaffolds, and answer keys. Use when the user asks to differentiate a worksheet, make multiple difficulty levels, scaffold an activity, or create leveled practice.
---
...
Turn one worksheet concept into beginner, standard, and advanced versions with differentiated instructions, scaffolds, and answer keys.

## Trigger

Use when the user asks to differentiate a worksheet, make multiple difficulty levels, scaffold an activity, or create leveled practice.

## Required outputs

- Skill objective and learner assumptions
- Beginner, standard, and advanced worksheet versions
- Differentiated instructions and supports
- Complete answer keys and teacher notes
- Print-ready files with clearly labeled levels

## Workflow

1. Identify the exact skill being practiced and what should remain consistent across levels.
2. Design beginner scaffolds, standard independent practice, and advanced extension without changing the core objective.
3. Generate simple original visuals with ChatGPT Image Generation 2.0 when visuals improve learning.
4. Write clear directions and balanced item counts.
5. Solve every item and create matching answer keys.
6. Audit difficulty progression, reading level, spacing, and accessibility.

## Quality checks

- Difficulty changes are meaningful, not merely more questions.
- No level requires untaught knowledge unless labeled as extension.
- Answer keys are complete and correct.
- Level labels are clear but not stigmatizing.
